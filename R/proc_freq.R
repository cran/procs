...
#' table variable values were encountered in the incoming data.}
...
#' and how those datasets are structured.
#'
#' There are three choices of datasets:
...
#' }
#' @section Plots:
#' The \code{proc_freq} function can generate plots. These plots
#' can be most easily generated by setting \code{plots = TRUE}.  The default
#' plots are bar charts showing the frequency counts for each category
#' and each table request. For two-way interactions, the function will
#' plot a bar chart for each interaction.
#'
#' In addition to standard bar charts, the function can produce dot plots, stacked
#' bar charts, and clustered bar charts.  To request these types of plots, pass
#' a \code{\link{freqplot}} function to the \code{plots} parameter.  The
#' \code{\link{freqplot}} function provides several optional parameters for customizing
#' your chart.  See the \code{\link{freqplot}} documentation for a full
#' list of options and more plot examples.
...
#' NULL, or a call to the \code{\link{freqplot}} function.  Default is NULL,
#' meaning no
...
#' # - path: 'C:\Users\dbosa\AppData\Local\Temp\RtmpOYrg1Y\file5dfa8212f57c7.jpg'
#' # - height: 4.5
#' # - width: 6
#' #
#' # $Eye
...
#' # $`Plots: Eye`
#' # # A plot specification:
#' # - path: 'C:\Users\dbosa\AppData\Local\Temp\RtmpOYrg1Y\file5dfa854b429fc.jpg'
#' # - height: 4.5
#' # - width: 6
#' #
#' # $Cross
...
#' # $`Plots: Hair * Eye`
#' # # A plot specification:
#' # - path: 'C:\Users\dbosa\AppData\Local\Temp\RtmpOYrg1Y\file5dfa87b6a3303.jpg'
#' # - height: 4.5
#' # - width: 6
#'
#' @import fmtr
