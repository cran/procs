---
title: "Example 3: Disposition"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example 3: Disposition}
...
The following example is an disposition table.  The report features extensive 
data preparation using the **procs** data manipulation functions. The example 
also shows how to create a stub column with summary statistics on all levels.
...
<img src="../man/images/disp.png" alt = "Disposition table"/>
